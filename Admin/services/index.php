    ...
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <div class="col-10 mt-3">
                <div class="shadow">
                    <p class="text-center font-weight-bold text-white p-2 bg-dark">Services Report </p>
                        ...
                        <table class="table table-bordered my-2">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Product Descrpition</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <th scope="row"><?php echo $data['s_id']; ?></th>
                                            <td><?php echo $data['title']; ?></td>
                                            <td><?php echo $data['s_desc']; ?></td>
                                            <td><?php echo $data['date']; ?></td>
                                            <td class="text-center text-success">
                                            <form action="edit.php" method="POST">
                                            <input type="hidden" value="<?php echo $data['s_id']; ?>" name="s_id">
                ...
                <div class="float-right bg-danger mr-3 shadow-lg" style="margin-top: 2rem;">
                    <a href="./add-services.php" class="text-white p-2"><i class="fas fa-plus fa-3x"></i></a>
                </div>
