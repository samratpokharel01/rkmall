...
if (isset($_POST['submit'])) {
    ...
    if ($title =="" || empty($s_desc) || $date =="") {
        ...
        $sql = "INSERT INTO services (title, s_desc, date, image) VALUES ('$title','$s_desc','$date','$file_name')";
                ...
                <div class="jumbotron">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="s_desc" type="text" class="form-control" id="exampleInputPassword1"> </textarea>
                        </div>
                        <div class="form-group">
