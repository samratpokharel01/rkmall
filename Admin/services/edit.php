...
if (isset($_POST['update'])) {
    ...
    if ($title =="" || empty($s_desc) || $date =="") {
        $empty_msg = "Please fill all the fields ";
    } else {
    
        $sql = "UPDATE services SET image = '$file_name', title='$title',s_desc ='$s_desc',date='$date' WHERE s_id = $id";
                ...
                <div class="jumbotron">
                    ...
                    <input type="hidden" name="s_id" value="<?php  echo $data['s_id'];   ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="s_desc" type="text" class="form-control"  id="exampleInputPassword1"> <?php echo $data['s_desc']; ?> </textarea>
                        </div>
                        <div class="form-group">
