...
if (isset($_POST['submit'])) {
    ...
    if ($title =="" || empty($n_desc) || $date =="") {
        ...
        $sql = "INSERT INTO news_notice (title, n_desc, date, image) VALUES ('$title','$n_desc','$date','$file_name')";
        ...
        <div class="row mt-5">
            <div class="col-md-2 col-sm-12 mt-5 ml-0">
                <ul class="nav flex-column bg-light">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active font-weight-bold" aria-current="page" href="" style="color: black;">
                ...
                <div class="jumbotron">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="n_desc" type="text" class="form-control" id="exampleInputPassword1"> </textarea>
                        </div>
                        <div class="form-group">
