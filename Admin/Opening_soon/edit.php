...
if (isset($_POST['update'])) {
    ...
    if ($c_name =="" || empty($c_desc) || $date =="") {
        ...
        $sql = "UPDATE opening_soon SET image = '$file_name', c_name='$c_name',c_desc ='$c_desc',o_date='$date' WHERE o_id = $id";
            ...
            <div class="col-10 mt-3">
                ...
                <div class="jumbotron">
                    <?php 
                        ...
                        $sql = "SELECT * FROM opening_soon WHERE o_id = $id";
                        $result = mysqli_query($conn,$sql);
                        $data = mysqli_fetch_assoc($result);
                    ?>
                    <form method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="o_id" value="<?php  echo $data['o_id'];   ?>">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Company Name</label>
                            <input type="text" class="form-control" name="c_name" id="exampleInputEmail1" value="<?php echo $data['c_name']; ?>" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Company Description</label>
                            <textarea name="c_desc" type="text" class="form-control"  id="exampleInputPassword1"> <?php echo $data['c_desc']; ?> </textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Opening Date</label>
                            <input type="date" class="form-control" name="date" value="<?php echo $data['o_date']; ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                        ...
                        <img src="../uploads/opening-soon/<?php echo $data['image']; ?>" class="img-fluid" alt="" height="250" width="250">
                        </div>
