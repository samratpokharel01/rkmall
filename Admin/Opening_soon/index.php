...
if (isset($_POST['Delete'])) {
    $id = $_POST['o_id'];
    $sql = "DELETE FROM opening_soon WHERE o_id = $id";
    ...
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <div class="col-10 mt-3">
                <div class="shadow">
                    <p class="text-center font-weight-bold text-white p-2 bg-dark">Opening Soon Report </p>
                        ...
                        <table class="table table-bordered my-2">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Company Descrpition</th>
                ...
                <div class="float-right bg-danger mr-3 shadow-lg" style="margin-top: 2rem;">
                    <a href="./add-new-company.php" class="text-white p-2"><i class="fas fa-plus fa-3x"></i></a>
                </div>
